package com.curso.lliteralura.principal;

import com.curso.lliteralura.model.*;
import com.curso.lliteralura.repository.IAutorRepository;
import com.curso.lliteralura.repository.ILibroRepository;
import com.curso.lliteralura.service.ConsumoAPI;
import com.curso.lliteralura.service.ConvierteDatos;
...
public class Principal {
    ...
    public Principal(IAutorRepository autoresRepositorio, ILibroRepository librosRepositorio) {
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            ...
            try {
                ...
                System.out.println("Error: Solo acepta numeros enteros");
